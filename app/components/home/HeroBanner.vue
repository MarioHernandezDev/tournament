<template>
  <div class="w-full space-y-6">
    ...
    <section class="relative w-full h-auto min-h-[100dvh] sm:min-h-0 bg-zinc-950 overflow-hidden px-4 sm:px-12 lg:px-20 pt-28 sm:pt-6 pb-12 sm:pb-6 flex flex-col justify-between sm:block">
      ...
      <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[900px] h-[300px] sm:h-[400px] bg-cyan-500/20 blur-[100px] sm:blur-[160px] rounded-full pointer-events-none z-10"></div>
      ...
      <div class="absolute inset-0 z-10 hidden sm:flex items-center lg:items-start lg:pt-12 justify-center pointer-events-none select-none overflow-hidden">
        <h1 class="font-['Rajdhani'] font-black uppercase text-[25vw] sm:text-[28vw] lg:text-[32vw] leading-none tracking-tighter whitespace-nowrap text-cyan-400/[0.09] drop-shadow-[0_0_90px_rgba(34,211,238,0.2)]">
          PROJECT
        </h1>
      </div>

      <!-- 4. PERSONAJE (Móvil: Integrado como capa visual / Desktop: Posición original intacta) -->
      <div class="absolute inset-x-0 bottom-0 sm:relative z-10 w-full flex items-end justify-center pointer-events-none overflow-hidden h-[55vh] sm:h-auto">
        <img 
          src="~/assets/img/fotofrente.png" 
          alt="Gaming Player" 
          class="h-full sm:h-auto w-auto sm:w-full object-cover object-bottom filter brightness-105 contrast-110 drop-shadow-[0_25px_50px_rgba(0,0,0,0.95)] [mask-image:linear-gradient(to_bottom,black_75%,transparent_100%)]"
        />
      ...
      <!-- 5. CONTENIDO TEXTO + BOTÓN (Móvil: Abajo sobre la sombra / Desktop: Posición original intacta) -->
      <div class="relative sm:absolute inset-x-0 sm:top-[35%] lg:top-[30%] z-30 max-w-[1500px] mx-auto px-2 sm:px-12 lg:px-20 w-full flex flex-col sm:flex-row items-center justify-between gap-8 pointer-events-none mt-auto sm:mt-0 pb-6 sm:pb-0">
        ...
        <div class="max-w-xl w-full space-y-4 sm:space-y-5 text-center sm:text-left pointer-events-auto">
          <h2 class="font-['Rajdhani'] text-4xl sm:text-6xl lg:text-7xl font-black uppercase tracking-tight text-white leading-[0.95] drop-shadow-[0_10px_20px_rgba(0,0,0,0.9)]">
            La Experiencia <br />
          ...
          <p class="text-zinc-200 text-sm sm:text-lg font-light leading-relaxed max-w-md mx-auto sm:mx-0 drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">
        ...
        <div class="hidden sm:flex items-center justify-center sm:justify-end w-full sm:w-auto pointer-events-auto">
          <img 
            src="/img/logo.webp" 
